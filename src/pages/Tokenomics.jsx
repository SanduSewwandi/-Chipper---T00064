  ...
  return (
    <div  id="tokenomics" className="w-full flex flex-col font-sans select-none overflow-x-hidden">
      ...
      <style>{`
        ...
        /* On md+ the gif is left-positioned; slide purely in X */
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              {copied ? (
                <span style={{ fontSize: 'clamp(7px, 1.1vw, 13px)' }} className="text-green-600 font-bold whitespace-nowrap">
                  Copied!
                </span>
              ) : (
                <svg
        ...
        >
          <img 
            ...
            style={{ width: 'clamp(6rem, 35vw, 500px)' }}
      ...
      >
        <div className="w-full flex flex-col md:flex-row justify-between items-center md:items-end gap-8 z-10">
          ...
          {/* SOCIAL ICONS — original layout preserved exactly */}
          <div className="flex gap-4 items-center justify-center md:justify-start w-full md:w-auto order-2 md:order-1 pb-2 md:pb-0">
          ...
          <div className="relative flex flex-col items-center w-full md:w-auto order-1 md:order-2">
            <div className="absolute top-0 right-2 md:right-0 -translate-y-[140%] pb-2 z-20 pointer-events-none">
              <img 
                ...
                className="w-16 h-auto sm:w-24 md:w-30 lg:w-50 object-contain" 
              />
            </div>
            <div className="w-full md:w-[460px] bg-white border-4 border-black rounded-2xl p-5 md:p-8 shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] flex flex-col items-center mt-6 md:-mt-[80px]">
