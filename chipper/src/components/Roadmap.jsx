...
function PhaseCard({ phase, className = "" }) {
  return (
    <div className={`bg-white border-[4px] border-black rounded-2xl p-5 md:p-6 shadow-[5px_5px_0px_0px_rgba(0,0,0,1)] text-center max-w-sm w-full z-30 ${className}`}>
      <h3
  ...
  return (
    ...
    >
      ...
      <div className="relative w-full max-w-5xl mx-auto min-h-[750px] mt-16">
        ...
        {/* 2. Center Piece Pathway Asset (Elevated to z-40 to appear in front of Phase Cards) */}
